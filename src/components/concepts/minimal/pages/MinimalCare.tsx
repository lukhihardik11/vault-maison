  ...
  return (
    <MinimalLayout>
      ...
      <section style={{ padding: '80px 5vw 0', maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
        <p style={{ fontFamily: font, fontSize: minimal.type.caption, }}><span className="brutalist-section-num">01 — Jewelry Care</span></p>
        <h1 style={{ fontFamily: font, fontSize: minimal.type.h2, fontWeight: 600, color: '#050505', marginBottom: '12px' }}>Care Guide</h1>
        <p style={{ fontFamily: font, fontSize: minimal.type.body, fontWeight: 400, lineHeight: 1.8, color: '#767676', maxWidth: '500px', margin: '0 auto' }}>
          ...
          {tips.map((t, i) => (
            <div key={i} style={{ padding: '32px', backgroundColor: '#FAFAFA' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
                ...
                <h3 style={{ fontFamily: font, fontSize: minimal.type.h4, fontWeight: 400, color: '#050505' }}>{t.title}</h3>
              </div>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                {t.items.map((item, j) => (
                  <li key={j} style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', padding: '8px 0', fontFamily: font, fontSize: minimal.type.bodySm, fontWeight: 400, lineHeight: 1.6, color: '#555' }}>
      ...
      <section style={{ padding: '60px 5vw 100px', maxWidth: '900px', margin: '0 auto' }}>
        <div style={{ padding: '40px', backgroundColor: '#050505', textAlign: 'center' }}>
          <h3 style={{ fontFamily: font, fontSize: minimal.type.h4, fontWeight: 400, color: '#FFFFFF', marginBottom: '12px' }}>Complimentary Lifetime Service</h3>
          <p style={{ fontFamily: font, fontSize: minimal.type.bodySm, fontWeight: 400, lineHeight: 1.8, color: 'rgba(255,255,255,0.5)', marginBottom: '24px', maxWidth: '500px', margin: '0 auto 24px' }}>
