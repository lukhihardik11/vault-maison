    ...
    <MinimalLayout>
      ...
      <section style={{ padding: '100px 5vw', maxWidth: '1200px', margin: '0 auto' }}>
        <div className="vm-about-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
          ...
          <FadeIn delay={200}>
            <div className="minimal-image-hover-reveal" style={{ position: 'relative', aspectRatio: '4/5', backgroundColor: '#FAFAFA', overflow: 'hidden', borderRadius: 0 }}>
      ...
      <style>{`
        ...
        .minimal-image-hover-reveal img { transition: transform 0.8s cubic-bezier(0.16, 1, 0.3, 1), filter 0.8s ease; }
        .minimal-image-hover-reveal:hover img { transform: scale(1.05); filter: brightness(0.95); }
