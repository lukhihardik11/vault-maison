  ...
  return (
    <main className="min-h-screen font-playfair" style={{ backgroundColor: "#2C1A1D", color: "#F5F0EB" }}>
      <nav className="fixed top-0 left-0 right-0 z-40 px-8 py-6 flex justify-between items-center backdrop-blur-sm" style={{ backgroundColor: "#2C1A1DE6" }}>
        <Link href="/archive" className="text-[10px] tracking-luxury-wide uppercase opacity-40 hover:opacity-100 transition-luxury font-sans">← Home</Link>
        <span className="text-[11px] tracking-luxury-wide uppercase opacity-60">The Archive — Collection</span>
