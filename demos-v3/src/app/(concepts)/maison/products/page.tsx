...
export default function MaisonProducts() {
  return (
    <main className="min-h-screen font-libre" style={{ backgroundColor: "#FAFAFA", color: "#1C1C1C" }}>
      <nav className="fixed top-0 left-0 right-0 z-40 px-8 py-6 flex justify-between items-center backdrop-blur-sm" style={{ backgroundColor: "#FAFAFAE6" }}>
        <Link href="/maison" className="text-[10px] tracking-luxury-wide uppercase opacity-40 hover:opacity-100 transition-luxury font-sans">← Home</Link>
        <span className="text-[11px] tracking-luxury-wide uppercase opacity-60">Modern Maison — Collection</span>
