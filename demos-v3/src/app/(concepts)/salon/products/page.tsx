  ...
  return (
    <main className="min-h-screen font-lora" style={{ backgroundColor: "#FDF5E6", color: "#2B2B2B" }}>
      <nav className="fixed top-0 left-0 right-0 z-40 px-8 py-6 flex justify-between items-center backdrop-blur-sm" style={{ backgroundColor: "#FDF5E6E6" }}>
        <Link href="/salon" className="text-[10px] tracking-luxury-wide uppercase opacity-40 hover:opacity-100 transition-luxury font-sans">← Home</Link>
        <span className="text-[11px] tracking-luxury-wide uppercase opacity-60">The Salon — Collection</span>
