...
export default function AtelierDetail({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="lg:sticky lg:top-28 lg:self-start">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}>
              ...
              <div className="h-px mb-8" style={{ backgroundColor: "#8C3A3A30" }} />
              <p className="text-2xl font-light mb-8 font-sans" style={{ color: "#8C3A3A" }}>{product.priceFormatted}</p>
              ...
              <button className="w-full py-4 text-[11px] tracking-luxury-wide uppercase border transition-luxury font-sans hover:opacity-80" style={{ borderColor: "#8C3A3A40" }}>
