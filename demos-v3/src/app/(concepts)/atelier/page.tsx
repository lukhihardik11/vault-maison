...
export default function AtelierHome() {
  ...
  return (
    <main className="min-h-screen font-cormorant" style={{ backgroundColor: "#F4F1EA", color: "#2B2B2B" }}>
      <nav className="fixed top-0 left-0 right-0 z-40 px-8 py-6 flex justify-between items-center" style={{ backgroundColor: "#F4F1EAE6" }}>
        ...
        <span className="text-[11px] tracking-luxury-wide uppercase opacity-60">The Atelier</span>
        <Link href="/atelier/products" className="text-[10px] tracking-luxury-wide uppercase opacity-40 hover:opacity-100 transition-luxury font-sans">Collection →</Link>
      </nav>
      ...
      <section className="py-section px-8 md:px-16">
        ...
        <div className="mt-16 text-center">
          <Link href="/atelier/products" className="inline-block px-12 py-4 text-[11px] tracking-luxury-wide uppercase border font-sans transition-luxury hover:opacity-80" style={{ borderColor: "#8C3A3A40" }}>
