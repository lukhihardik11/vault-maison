      ...
      <section style={{ padding: '60px 5vw 100px', maxWidth: '1200px', margin: '0 auto', minHeight: '70vh' }}>
        <div style={{ marginBottom: '48px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
            ...
            {items.length > 0 && <p style={{ fontFamily: font, fontSize: '12px', color: '#8B8B8B' }}>{items.length} {items.length === 1 ? 'piece' : 'pieces'}</p>}
          </div>
        </div>
        ...
        {items.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '80px 0' }}>
            ...
            <p style={{ fontFamily: font, fontSize: '13px', fontWeight: 300, color: '#8B8B8B', marginBottom: '32px' }}>Save pieces you love by clicking the heart icon.</p>
