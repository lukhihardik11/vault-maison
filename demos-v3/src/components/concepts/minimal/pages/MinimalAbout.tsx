    ...
    <MinimalLayout>
      ...
      <section style={{ padding: '100px 5vw', maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ position: 'relative' }}>
          <div className="vm-timeline-line" style={{ position: 'absolute', left: '50%', top: 0, bottom: 0, width: '1px', backgroundColor: '#E8E5E0', transform: 'translateX(-50%)' }} />
          {milestones.map((m, i) => (
            <FadeIn key={i} delay={i * 100}>
              <div className="vm-timeline-item" style={{ display: 'flex', justifyContent: i % 2 === 0 ? 'flex-start' : 'flex-end', position: 'relative', marginBottom: '48px' }}>
                ...
                <div className="vm-timeline-dot" style={{ position: 'absolute', left: '50%', top: '8px', width: '10px', height: '10px', borderRadius: '50%', backgroundColor: '#C4A265', transform: 'translateX(-50%)', zIndex: 2 }} />
              </div>
            </FadeIn>
          ))}
        </div>
      ...
      <style>{`
        ...
        .abt-cta-secondary:hover { border-color: #C4A265 !important; color: #C4A265 !important; }
