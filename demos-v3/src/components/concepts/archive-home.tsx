  ...
  return (
    <ConceptLayout concept={concept}>
      ...
      <section className="relative min-h-screen flex items-center" style={{ backgroundColor: concept.palette.bg }}>
        ...
        <div className="relative z-10 mx-auto max-w-[1440px] px-6 lg:px-12 py-32 w-full">
          <div className="max-w-2xl">
            ...
            <h1 className={`text-4xl md:text-6xl lg:text-7xl font-light tracking-[0.02em] leading-[1.1] mb-6 ${concept.fonts.headingClass}`} style={{ color: concept.palette.text }}>
              Every Stone<br />
              Carries <em className="italic" style={{ color: concept.palette.accent }}>History</em>
            </h1>
            <p className="text-sm font-light mb-10 leading-relaxed max-w-lg" style={{ color: concept.palette.text, opacity: 0.5 }}>
      ...
      <section className="py-12" style={{ backgroundColor: concept.palette.surface }}>
        <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {[
              { value: '5,000+', label: 'Years of Diamond History' },
      ...
      <section className="py-20 lg:py-28" style={{ backgroundColor: concept.palette.bg }}>
        <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
          <p className="text-[10px] uppercase tracking-[0.2em] mb-4" style={{ color: concept.palette.text, opacity: 0.4 }}>Heritage Timeline</p>
            ...
            {timeline.map((item, i) => (
              ...
              >
                ...
                <div className={`ml-12 md:ml-0 md:w-1/2 ${i % 2 === 0 ? 'md:pl-12' : 'md:pr-12 md:text-right'}`}>
                  ...
                  <p className="text-sm font-light leading-relaxed" style={{ color: concept.palette.text, opacity: 0.6 }}>{item.event}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 lg:py-32" style={{ backgroundColor: concept.palette.surface }}>
        <div className="mx-auto max-w-4xl px-6 lg:px-12">
          <p className={`text-2xl md:text-3xl lg:text-4xl font-light leading-relaxed ${concept.fonts.headingClass}`} style={{ color: concept.palette.text }}>
            &ldquo;Knowing the complete history of a diamond, from the mine to the cutting house, gives it a meaning that transcends its material value. Provenance is the soul of every extraordinary gem.&rdquo;
          </p>
        </div>
      </section>
