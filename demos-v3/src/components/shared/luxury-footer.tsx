  ...
  const columns = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Press', href: buildConceptUrl(concept.id, 'press') },
        { label: 'Our Stores', href: buildConceptUrl(concept.id, 'stores') },
    ...
    },
    {
      title: 'Support',
      links: [
        { label: 'Shipping', href: buildConceptUrl(concept.id, 'shipping') },
        { label: 'Returns & Exchanges', href: buildConceptUrl(concept.id, 'returns') },
        { label: 'Care Guide', href: buildConceptUrl(concept.id, 'care') },
        { label: 'FAQ', href: buildConceptUrl(concept.id, 'faq') },
        { label: 'Book Appointment', href: buildConceptUrl(concept.id, 'appointments') },
        { label: 'Accessibility', href: buildConceptUrl(concept.id, 'accessibility') },
